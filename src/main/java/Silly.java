...
public class Silly implements Comparable<Silly>{
     ...
     */
    /**
     * Creates a new silly object with its name as the concatenation of the two strings
     * @param str1 the first part of the object's name
     * @param str2 the second part of the object's name
     */
